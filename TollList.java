...
public class TollList extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae){
		...
		if(clickedButton.equals("Search")){
			...
			String getUserType = "SELECT admin from client WHERE username = '" + salutation + "'";
			ResultSet rs = null;
			try {
				...
				if(rs.next()) {
					...
					if(userType.equals("0")) { // client type user
						// this is a common page for both admin and client and so controlling home page redirection dynamically
